...
import com.norra.cloud.http.frame.ImageLoadListener.LoadFrom;
import com.norra.cloud.http.frame.Request.RequestMethod;
...
public class ImageLoadTask implements Runnable {
	...
	private Bitmap loadBitmap() throws IOException {
		...
		HttpResponse httpResponse = httpWorker.doHttpRequest(request);
