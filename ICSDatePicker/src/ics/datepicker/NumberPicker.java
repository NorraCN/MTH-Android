...
public class NumberPicker extends LinearLayout {
     ...
     * Add by charliu
     */
    private final int mSelectionDividerMarginLeft;

    private final int mSelectionDividerMarginRight;
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectionDividerMarginLeft = attributesArray.getDimensionPixelOffset(R.styleable.NumberPicker_selectionDividerMarginLeft, 0);

        mSelectionDividerMarginRight = attributesArray.getDimensionPixelOffset(R.styleable.NumberPicker_selectionDividerMarginRight, 0);
     ...
     * <p>
     * If the argument is less than the {@link ics.datepicker.NumberPicker#getMinValue()} and
     * {@link ics.datepicker.NumberPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link ics.datepicker.NumberPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link ics.datepicker.NumberPicker#getMinValue()} and
     * {@link ics.datepicker.NumberPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link ics.datepicker.NumberPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link ics.datepicker.NumberPicker#getMaxValue()} and
     * {@link ics.datepicker.NumberPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link ics.datepicker.NumberPicker#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link ics.datepicker.NumberPicker#getMinValue()} and
     * {@link ics.datepicker.NumberPicker#getMaxValue()} values.
     * <p>
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mSelectionDivider != null) {
            ...
            mSelectionDivider.setBounds(mSelectionDividerMarginLeft, topOfTopDivider,
                    getWidth() - mSelectionDividerMarginRight, bottomOfTopDivider);
            mSelectionDivider.draw(canvas);

            // draw the bottom divider
            int bottomOfBottomDivider = mBottomSelectionDividerBottom;
            int topOfBottomDivider = bottomOfBottomDivider - mSelectionDividerHeight;
            mSelectionDivider.setBounds(mSelectionDividerMarginLeft, topOfBottomDivider,
                    getWidth() - mSelectionDividerMarginRight, bottomOfBottomDivider);
            mSelectionDivider.draw(canvas);
        }
    }
    ...
    /**
     * Posts an {@link ics.datepicker.NumberPicker.SetSelectionCommand} from the given <code>selectionStart
