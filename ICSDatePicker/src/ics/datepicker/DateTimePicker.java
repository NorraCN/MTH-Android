 ...
 * year, month, and day spinners or a {@link ics.datepicker.CalendarView}. The set of spinners
...
//                R.layout.date_time_picker_holo);
        int layoutResourceId = R.layout.date_time_picker_holo;
...
//        reorderSpinners();
    ...
    /**
     * Sets the minimal date supported by this {@link ics.datepicker.NumberPicker} in
    ...
    /**
     * Sets the maximal date supported by this {@link ics.datepicker.DateTimePicker} in
     * milliseconds since January 1, 1970 00:00:00 in
     * {@link java.util.TimeZone#getDefault()} time zone.
     *
...
//        super.onPopulateAccessibilityEvent(event); //fix onPopulateAccessibilityEvent method not found exception
    ...
    /**
     * Sets whether the {@link ics.datepicker.CalendarView} is shown.
     *
    ...
    private void setCurrentLocale(Locale locale) {
        ...
        for (int i = 0; i < mNumberOfMonths; i++) {
            String mon = DateUtils.getMonthString(Calendar.JANUARY + i,
                    DateUtils.LENGTH_MEDIUM);
            if (mon.substring(mon.length() - 2).equals("月")) {
                mShortMonths[i] = mon.substring(0, mon.length() - 2);
            } else {
                mShortMonths[i] = mon;
            }
...
//    }
    ...
    public void updateDate(int year, int month, int dayOfMonth) {
        ...
        setDate(year, month, dayOfMonth, -1, -1);
        updateSpinners();
        notifyDateChanged();
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        setDate(ss.mYear, ss.mMonth, ss.mDay, -1, -1);
        updateSpinners();
    }
    ...
    public void init(int year, int monthOfYear, int dayOfMonth,
        ...
        setDate(year, monthOfYear, dayOfMonth, -1, -1);
        updateSpinners();
    ...
    private static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link ics.datepicker.DateTimePicker#onSaveInstanceState()}
         */
