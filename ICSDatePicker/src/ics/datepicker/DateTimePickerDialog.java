...
import ics.datepicker.DateTimePicker.OnDateChangedListener;
...
public class DateTimePickerDialog extends Dialog implements OnClickListener {
	...
	public interface OnDateSetListener {
		 ...
		 */
		void onDateSet(DateTimePicker view, int year, int monthOfYear, int dayOfMonth);
	}
...
//		updateTitle(year, monthOfYear, dayOfMonth);
		...
		public void onClick(View v) {
			if (v.getId() == ok.getId()) {
				...
				if (listener != null) {
					...
					calendar.set(Calendar.HOUR_OF_DAY, mDatePicker.getHour());
					calendar.set(Calendar.MINUTE, mDatePicker.getMinute());
	...
	/**
	 * Gets the {@link ics.datepicker.DatePicker} contained in this dialog.
	 *
